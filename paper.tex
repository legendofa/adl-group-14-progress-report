...
\icmlauthor{Kieslinger, Julian Felix 2025-82736}{ds}
...
we have been working on integration of necessary components for our agent,
    reproducing baseline model Zep (of which the source code is not publicly available),
...
by maximizing the utilization of Graphiti and taking the community node off the scope as stated in
